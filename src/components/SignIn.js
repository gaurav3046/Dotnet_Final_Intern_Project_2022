...
export default class SignIn extends Component {
  ...
  handleSubmit = (e) => {
    ...
    if (this.state.UserName !== '' && this.state.Password !== '') {
      ...
      authServices
        .SignIn(data,console.log("inside "+data.password))
        .then((data) => {
          console.log('Data : ', data)
          if (data.data.isSuccess) {
            var login={login:true,token:data.data.obR.value.access_token,UserId:data.data.UserId,UserId:data.data.userId}
      ...
      <div className="SignUp-Container">
        <div className="SignUp-SubContainer">
          ...
          <div className="Buttons" style={{ alignItems: 'flex-start' }}>
            <Button className="Btn" color="inherit" onClick={this.handleSignUp}>
              Sign Up
            </Button>
            <Button
              className="Btn"
